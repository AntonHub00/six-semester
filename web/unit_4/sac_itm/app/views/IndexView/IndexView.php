...
<html lang="es">
  ...
  <body>
	...
	<div class="signin-grid-item otro1">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
	<div class="signin-grid-item otro2">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
	<div class="signin-grid-item otro3">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
	<div class="signin-grid-item otro4">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
	<div class="signin-grid-item otro5">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
	<div class="signin-grid-item otro6">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
	<div class="signin-grid-item otro7">
          <label for="password">Contraseña</label>
          <input type="password" id="signin-password" name="password"
		 placeholder="Contraseña" maxlength="15" class="" required>
	</div>
